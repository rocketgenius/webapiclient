...
class GFFormsTable extends WP_List_Table {
	...
	function get_columns() {
		return array( 'title' => 'Title', 'id' => 'Id', 'entries' => 'Entries' );
	}
	...
	function column_title( $item ) {
		...
		$actions = array(
			'edit'    => "<a title='Edit Form' href=' " . add_query_arg( array( 'form_id' => $item['id'] ) ) . "'>Edit</a>",
			'entries' => "<a title='View Entries' href=' " . add_query_arg( array(
					'form_id' => $item['id'],
					'view'    => 'entries',
				) ) . "'>Entries</a>",
			'results' => "<a title='View Results' href=' " . add_query_arg( array(
					'form_id' => $item['id'],
					'view'    => 'results'
				) ) . "'>Results</a>",
