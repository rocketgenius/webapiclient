...
if(class_exists("GFForms")){
    ...
    class GFWebAPIClient extends GFAddOn{
        ...
        public function plugin_settings_fields(){
            return array(
                array(
                    "title" => __("Web API Information", "gravityformsaweber"),
        ...
        protected function form_list_page()
        {
            ...
            if($api == false){
                ?>
                <div class="updated" style="padding:15px;">Your Web API settings haven't been configured yet. <a href="<?php echo admin_url("admin.php?page=gf_settings&subview=Web API Client")?>">Lets go set them up!</a></div>
                <?php
                return;
            }
        ...
        private function maybe_delete_form(){
        ...
        protected function entry_list_page($form_id)
        {
        ...
        protected function form_edit_page($form_id){
            ...
            $form = empty($form_id) ? array("id" => "", "title" => "", "is_active"=>1) : $api->get_form($form_id);
                ...
                <form method="post" id="gform_form_settings">
                    ...
                    <table class="gforms_form_settings" style="width:100%;">
                        <tbody>
                            ...
                            <tr>
                                <th>Title</th>
                                <td><input type="text" name="gform_form_title" value="<?php echo esc_attr($form["title"])?>"/></td>
                            </tr>
                            <tr>
                                <th>Active</th>
                                <td>
                                    <input type="radio" value='1' name="gform_form_active" <?php checked(empty($form["is_active"]), false)?>> Yes&nbsp;&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value='0' name="gform_form_active" <?php checked(empty($form["is_active"]), true)?>> No
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <textarea name="gform_form_meta" style="width:750px; height:300px;"><?php echo json_encode($form)?></textarea>
            ...
            <div id="entry_detail">
                <form method="post">
                    ...
                    <table class="gforms_form_settings" style="width:100%;">
                        ...
                        <tr>
                            <td colspan="2">
                                <textarea name="gform_entry_meta" style="width:750px; height:300px;"><?php echo json_encode($entry)?></textarea>
        ...
        protected function results_page($form_id){
